...
def sync_users():
    ...
    smtp_password = 'x2doq8cVh7BtDMojbCVFAVikTMVbRn'
    arr={}
    arr_lead={}
    arrpro={}
    ...
    cursor.execute("SELECT TOP (1) [index],[name],[email],[phone],[id],[id_type],[type],[condominium],[ftth],[mobile],[province],[canton],[district],[address],[plan],[dates],[user_agent],[ip_address],[status],[reference],[create_time],[extra_iptv],[promcode],[crm_status] FROM [ADNPayV2].[dbo].[Customer] where status ='approved' and type = 'customer' and crm_status = '0'")
