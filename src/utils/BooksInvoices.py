...
class BooksInvoices(BooksConnection):
    ...
    def get_records(self, queryparams, page = 1):
        ...
        request_query = {
            "url": f'https://books.zoho.com/api/v3/invoices?page={str(page)}&organization_id={ZBOOKS_ORGANITATION_ID}',
    ...
    def find_record(self,queryparams=1):
        get_single_invoice = requests.get(
            f'https://books.zoho.com/api/v3/invoices?organization_id={ZBOOKS_ORGANITATION_ID}&due_date_after=2022-07-01', headers=self.headers)

        print(get_single_invoice)
